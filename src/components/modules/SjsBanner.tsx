// Pure View — 森鉅旭 主視覺 Banner（全螢幕背景圖 + Logo + 標題）
import type { ModuleProps } from './index'

interface SjsBannerData {
...
export function SjsBanner({ module }: ModuleProps) {
  const d = module.data as unknown as SjsBannerData
